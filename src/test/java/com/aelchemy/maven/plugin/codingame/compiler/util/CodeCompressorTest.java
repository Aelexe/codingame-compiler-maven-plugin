...
public class CodeCompressorTest {
	...
	public void testCompressCode_SimpleClass() throws IOException, URISyntaxException {
		TestUtil.assertStringEquals(TestUtil.readResourceFile("/code_content/compressed/SimpleClass.java"),
	...
	public void testCompressCode_StringClass() throws IOException, URISyntaxException {
		TestUtil.assertStringEquals(TestUtil.readResourceFile("/code_content/compressed/StringClass.java"),
	...
	public void testCompressCode_PackagedClass() throws IOException, URISyntaxException {
		TestUtil.assertStringEquals(TestUtil.readResourceFile("/code_content/compressed/PackagedClass.java"),
	...
	public void testCompressCode_ImportClass() throws IOException, URISyntaxException {
		TestUtil.assertStringEquals(TestUtil.readResourceFile("/code_content/compressed/ImportClass.java"),
	...
	public void testCompressCode_InterfaceClass() throws IOException, URISyntaxException {
		TestUtil.assertStringEquals(TestUtil.readResourceFile("/code_content/compressed/InterfaceClass.java"),
